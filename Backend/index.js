...
io.on('connect', (socket) => {
    ...
    socket.on('putUrl', async () => {
        ...
        async function getYoutubePlaylist() {
            let data = await axios.get('https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PLFFGmz6nJTieHdFyftKuo_E_GLTUeDurd&key='
                + config.key)
            //console.log(data)
